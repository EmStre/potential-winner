    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Istut perjantai-iltana yksin C#-ryhmän Hejlsberg-luokassa kun huomaat kattolamppujen valon värisevän.\n" +
                ...
                "Istut hetken yllättyneenä pimeässä luokassa ihmetellen tapahtunuttat. Vilkaiset kännykästäsi kelloa ja toteat sen olevan 23:18. Huomaat samalla kännykän kuuluvuuskentän olevan nollassa.");
            hejlsberg.Avaa();
        }
    }
}
